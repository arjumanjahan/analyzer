...
import com.nasa.analyzer.{AccessLog,AnalyzerTransformer}
import org.apache.spark.sql.Dataset
import org.apache.spark.sql.expressions.Window
import org.scalatest.funsuite.AnyFunSuite


class AnalyzerTransformerTest extends AnyFunSuite with SparkSessionTestWrapper {
  ...
  val accessLogLinesTopVisitors = AnalyzerTransformer.getTopNVisitors(
    accessLogLines,
    numOfResultsToFetch,
    window)
  //Get top N urls against the test data with filter codes set
  val accessLogLinesTopUrlsWithFilters = AnalyzerTransformer.getTopNUrls(
    accessLogLines,
    numOfResultsToFetch,
    window,
    filterResponseCodesSeq_test1)
  //Get top N visitors against the test data with no filter codes set
  val accessLogLinesTopUrlsWithoutFilters = AnalyzerTransformer.getTopNUrls(
    accessLogLines,
    numOfResultsToFetch,
    window,
  ...
  test("Visitor-record of top url of getTopNUrls with responseCode filter disabled") {
    assert(accessLogLinesTopUrlsWithFilters.take(1)(0)(0) == "/history/apollo/images/apollo-small.gif")
  ...
  test("Visitor-record of top url of getTopNUrls with responseCode filter enabled") {
    assert(accessLogLinesTopUrlsWithoutFilters.take(1)(0)(0) == "/history/apollo/images/apollo-small.gif")
  ...
  def setup_test_env() = {
    ...
    rawDataWithHttp = Seq(
      ("129.48.125.52 - - [28/Jul/1995:11:38:24 -0400] \"GET /history/apollo/images/apollo-small.gif HTTP/1.0\" 200 9630"),
      ("129.48.125.52 - - [28/Jul/1995:11:38:24 -0400] \"GET /images/KSC-logosmall.gif HTTP/1.0\" 200 1204"),
      ("internet-gw.ford.com - - [28/Jul/1995:11:38:28 -0400] \"GET /elv/hot.gif HTTP/1.0\" 200 1007"),
      ("n1123209.ksc.nasa.gov - - [28/Jul/1995:11:38:29 -0400] \"GET /images/ksclogo-medium.gif HTTP/1.0\" 200 5866"))

    rawDataWithoutHttp = Seq(
      ("129.48.125.52 - - [28/Jul/1995:11:38:24 -0400] \"GET /history/apollo/images/apollo-small.gif\" 200 9630"),
      ("129.48.125.52 - - [28/Jul/1995:11:38:24 -0400] \"GET /images/KSC-logosmall.gif\" 404 1204"),
      ("internet-gw.ford.com - - [28/Jul/1995:11:38:28 -0400] \"GET /elv/hot.gif\" 200 1007"))
